...
# Load gene-level GRCCA results to analyze
...
analysis_dir <- "grcca_permutation_VARx0.1_1_L2xNfeat_groupL2x0.1_noCmat_allEffects"
...
# tables_dir <- paste0(base_dir, "outputs/tables/27Aug_update/")
# if (!exists(tables_dir)) {dir.create(tables_dir)}
...
# ),
# paste0(tables_dir, "gene_GRCCA_results.xlsx")
# )
