---
title: "02a-00. Define X.mat, Y.mat, and C.mat to include in (G)RCCA analysis"
author: "Rachel Smith"
format: html
editor: visual
---

Select samples and variables for (G)RCCA. Define X (gene expression), Y (covariates/diagnosis), and C (confounds) matrices.

This is a general script to be used across (G)RCCA analyses
