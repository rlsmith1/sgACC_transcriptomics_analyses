...
## Load and combine SNAP L4 loadings with GRCCA rx
## to understand the relationship between GRCCA results and state-of-the-art
## single cell literature (https://www.nature.com/articles/s41586-024-07109-5)
