...
#==============================================================================#
# Run GRCCA including different diagnostic groups
#==============================================================================#

## Assesses the extent to which GRCCA results across SCZ, BD, and MDD are related
## This script loads the results from GRCCA runs including BD-only, MDD-only, and
## "composite" case, which included 1 diagnosis column indicating if the individual
## was diagnosed with -any- of SCZ, BD, or MDD (1) or no psychiatric diagnosis (0)


## Load data & functions
base_dir <- "~/Documents/PhD/projects/sgacc_wgcna_grcca/"
source(paste0(base_dir, "load_WGCNA_res.R"))
