...
```{r Fig4f.prep}
load(paste0(objects_dir, "GRCCA_enrichment_benchmark_res.Rdata"))
load(paste0(objects_dir, "DE_enrichment_benchmark_res.Rdata")) # Assuming this filename based on 01_DGE conversion
...
```{r Fig4f.plot, fig.width = 2.17, fig.height = 1.50}
df_fig4f %>% 
