---
title: "06b_SENS-cross-disorder-composite"
author: "Rachel Smith"
format: html
editor: visual
---
...
## Figure R3C3A | Cross-disorder model significance

```{r FigR3C3A.plot, fig.width=6.5, fig.height=2.5}
...
## Figure R3C3B | Cross-disorder covariate (Y) results

```{r FigR3C3B.plot, fig.width=2.5, fig.height=3.7}
...
## Figure R3C3C | Gene-level comparison (correlation)

```{r FigR3C3C.plot, fig.width=4.0, fig.height=3.5}
## Gene X res
df_xdx_xres <- map(
    .x = l_grcca_res, # BD & MDD
    .f = ~ .x$x_res
...
## Figure R3C3D | Gene-level overlaps (after threshold for significance)

```{r FigR3C3D.plot, fig.width=6.5, fig.height=3}
