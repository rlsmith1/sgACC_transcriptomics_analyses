...
#==============================================================================#
# Character the biological enrichments of the assigned modules
#==============================================================================#

## Run GO and cell-type enrichment on WGCNA modules (gene-level)
## Goal is to understand what each module represents biologically
## Includes GO (+ topic modeling), cell type, and developmental trajectory
...
## Save results
save(df_mods_go, 
     file = paste0(objects_dir, prefix, sep = "_", "SIGNED_SFT", soft_power, "_GO_RES.RDS"))
...
## Goal: understand what biological processes each module represents using the
## semantic similarity across GO term descriptions
