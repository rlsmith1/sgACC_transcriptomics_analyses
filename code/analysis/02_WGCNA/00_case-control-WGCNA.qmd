...
figures_dir <- paste0(base_dir, "outputs/figures/Fig1_studyOverview/")
...
# WGCNA package should be loaded by load_genes.R or setup.R, but ensuring it here
library(WGCNA)
library(tidyverse)
library(paletteer)
```
