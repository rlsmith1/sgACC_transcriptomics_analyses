---
title: "00-04b. Sensitivity analysis: Rerun toxicology MCA treating missing variables by filling in the individual-level mode"
author: "Rachel Smith"
format: html
editor: visual
---
...
map(
    .x = c(".png", ".pdf"),
    .f = ~ ggsave(paste0(supp_figures_dir, "S4A.sample_toxicology_matrix", .x), 
...
map(
    .x = c(".png", ".pdf"),
    .f = ~ ggsave(paste0(supp_figures_dir, "S4C.MCA_variable_loadings", .x), 
