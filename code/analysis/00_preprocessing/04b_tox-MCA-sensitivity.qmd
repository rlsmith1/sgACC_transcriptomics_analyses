---
title: "04b_tox-MCA-sensitivity"
author: "Rachel Smith"
format: html
editor: visual
---

# Rerun toxicology MCA treating missing variables by filling in the individual-level mode
...
```{r fig_s3a, fig.width=6.5, fig.height=2.25}
...
```{r fig_s3b, fig.width=2.0, fig.height=2.5}
## MCA eigenvalues
df_eig %>% 
...
```{r fig_s3c, fig.width=4.5, fig.height=3.3}
...
```{r fig_s3d, fig.width=6.5, fig.height=3.4}
