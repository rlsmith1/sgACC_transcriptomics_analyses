...
# to reduce dimensionality of toxicology data for GRCCA
#==============================================================================#

## Run MCA (dimensionality reduction for categorical data)
## This decreases the number of features we include in the Y (covariate) matrix,
## thus mitigating overfitting while still representing the covariate information
