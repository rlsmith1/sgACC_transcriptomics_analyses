---
title: "00-00. Tidy covariate data for downstream analyses"
author: "Rachel Smith"
format: html
editor: visual
---
...
drug_covariates <- c("smoker", "nicotine_cotinine", "alcohol", "opioids",
                      "beta_blockers", "major_stimulants_cocaine_included", "cannabinoids",
...
shared_variables <- intersect(colnames(df_complete_covariates2), 
                              colnames(df_nirmala_covariates))
...
#      file = paste0(objects_dir, "22Jan2025_covariates.Rdata")
# )
```

## Export covariates table for supplement
