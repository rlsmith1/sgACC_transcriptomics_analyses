...
#==============================================================================#
# Filter transcripts based on coefficient of variation
#==============================================================================#

## Due to a high number of features, the transcript-level data requires some
## extra filtering to remove uninformative features (for computational efficiency)
## Because variance scales with mean, we use coefficient of variation (CV)
## i.e., how variable is the transcript across samples given its expression levels?
## To avoid simply filtering out rare (less expressed) transcripts
...
# However, we don't just want to filter on variance because variance scales with mean
## and some transcripts have very low expression
# So we can use CV, which filters on variance relative to mean
