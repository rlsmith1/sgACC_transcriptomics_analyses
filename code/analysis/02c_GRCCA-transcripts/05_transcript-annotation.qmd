---
title: "05. Transcript-level annotations"
author: "Rachel Smith"
format: html
editor: visual
---
...
Generates Figure 5D (CSMD1 example) and Figure S14 (PTK2B, ARHGAP44).
...
### Figure S14 \| Additional examples (PTK2B, ARHGAP44)

```{r FigS14.plots, fig.width=6.5, fig.height=4.5}
figS14a <- f_plot_isoform_data("PTK2B")
map(
    .x = c(".png", ".pdf"),
    .f = ~ ggsave(paste0(supp_figures_dir, "S14A.PTK2B", .x), plot = figS14a, 
                  width = 6.5, height = 4.5)
)
...
map(
    .x = c(".png", ".pdf"),
    .f = ~ ggsave(paste0(supp_figures_dir, "S14B.ARHGAP44", .x), plot = figS14b, 
                  width = 6.5, height = 4.5)
)
...
map(
    .x = c(".png", ".pdf"),
    .f = ~ ggsave(paste0(supp_figures_dir, "S14C.CSDE1", .x), 
                  width = 6.5, height = 4.5)
)
```
