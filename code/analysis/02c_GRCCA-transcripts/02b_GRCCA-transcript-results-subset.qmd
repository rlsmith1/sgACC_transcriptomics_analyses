---
title: "02b. Load transcript-level GRCCA results (SUBSET)"
author: "Rachel Smith"
format: html
editor: visual
---
...
### Figure S13C \| Optimal model for subset transcripts
...
map(
  .x = c(".png", ".pdf"),
  .f = ~ ggsave(paste0(supp_figures_dir, "S13C.optimal_model_subset_transcripts", .x),
                width = 6.5, height = 5)
)
```
