...
#==============================================================================#
# Run differential expression analysis using Limma-voom
#==============================================================================#

## This script uses limma-voom to run DGE
## The model matrix includes the covariates that were selected
## as part of gene raw count preprocessing.
