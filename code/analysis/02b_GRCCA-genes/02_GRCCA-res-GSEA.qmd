---
title: "02. Characterize the biological enrichments of GRCCA data using GSEA"
author: "Rachel Smith"
format: html
editor: visual
---
...
map(
  .x = c(".png", ".pdf"),
  .f = ~ ggsave(paste0(figures_dir, "3Atop.Risk_gene_enrichment", .x), 
                width = 2.5, height = 2)
)
```
...
map(
  .x = c(".png", ".pdf"),
  .f = ~ ggsave(paste0(figures_dir, "3Abottom.Risk_gene_enrichment", .x), 
