---
title: "05. Relate GRCCA results vector to SCZ literature"
author: "Rachel Smith"
format: html
editor: visual
---
...
## Plot S19 \| GRCCA correlation with SNAP program by cell type
...
df_lf4 %>% 
    ...
    labs(x = "Ling et al LF4", y = "GRCCA structure correlation (r)",
         title = "S19 | GRCCA correlation with SNAP program by cell type")
```
