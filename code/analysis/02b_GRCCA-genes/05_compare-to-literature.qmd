---
title: "02b-05. Relate GRCCA results vector to SCZ literature"
author: "Rachel Smith"
format: html
editor: visual
---

Load and combine SNAP L4 loadings with GRCCA rx to understand the relationship between GRCCA results and state-of-the-art single cell literature \[Ling et al *Nature* (2024)\](https://www.nature.com/articles/s41586-024-07109-5).
...
# Downloaded from Ling et al Supplement
df_loading_factors <- read_xlsx("~/Downloads/41586_2024_7109_MOESM6_ESM.xlsx", 
                                sheet = "Gene loadings")
...
### Figure S19 \| GRCCA correlation with SNAP program by cell type
...
map(
    .x = c(".png", ".pdf"),
    .f = ~ ggsave(paste0(supp_figures_dir, "S19.correlation_with_SNAP", .x), 
