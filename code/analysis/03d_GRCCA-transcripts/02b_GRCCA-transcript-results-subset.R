...
# Load transcript-level GRCCA results for subset results
# Include: transcript derivatives of 1) common variant-associated genes of any psychiatric
# disorder, or 2) genes significantly associated with the latent variable in the gene-
# level GRCCA (at FDR < 0.05)
