...
# All trancsripts included, not subset by gene-level results
...
# Figures
save(df_results_ALLtranscripts, df_lvs_ALLtranscripts, df_y_res_ALLtranscripts, df_x_res_ALLtranscripts,
     file = paste0(analysis_objects_dir, "GRCCA_transcript_results_FULL.Rdata")
)
