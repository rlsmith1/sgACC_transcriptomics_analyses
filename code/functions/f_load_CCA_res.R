...
## - analysis_directory = directory that contains all frameworks you want to load (within the cca_dir; define in parent script)
## - type = specify if genes or transcripts (character)
## - rename_covariates = logical indicating whether or not to relabel covariates in df_y_res (usually true, unless you have unusual covariates)

#------------------------------------------------------------------------------#


f_load_cca_res <- function(
    ...
    results_dir <- paste0(cca_directory, "framework/", analysis_directory)
